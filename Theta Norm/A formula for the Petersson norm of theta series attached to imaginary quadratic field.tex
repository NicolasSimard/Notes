...
\[\langle\tpsi,\tpsi\rangle = V_D^{-1}\frac{|D|^\ell}{2^{2\ell}}\frac{4h_K}{w_K^2}\frac{1}{2(2\pi i)^2}\sum_{[\ida]=[\latbasis]}\frac{\psi^2(\ida)}{\omega_2^{4\ell}}\del^{2\ell-1}G_{2}(\omquot,0),\]
which can be rewritten as
\begin{equation}\label{eq:finallgeq1}
\langle\tpsi,\tpsi\rangle=V_D^{-1}(|D|/4)^\ell\frac{4h_K}{w_K^2}\sum_{[\ida]=[\latbasis]}\frac{\psi^2(\ida)}{\omega_2^{4\ell}}\del^{2\ell-1}E_{2}(\omquot).
\end{equation}
