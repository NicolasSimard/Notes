...
\frame{
	...
	See calculations at \url{https://github.com/NicolasSimard/ENT/blob/master/comps/ULcomps1.gp}
	}
}
...
\frame{
	...
	\only<2->{
	See calculations at \url{https://github.com/NicolasSimard/ENT/blob/master/comps/ULcomps2.gp}
	}
}
...
\frame{
	...
	Using the relation
	\[\theta_{\psi}(q)=\frac{1}{w_K}\sum_{j=1}^{h_K}\psi^{-1}(\fa_j)\theta_{\fa_j,0}(q)\]
...
\frame{
	...
	\begin{itemize}
		\item \url{https://github.com/NicolasSimard/Notes}
	\end{itemize}		

	Code available at :
	\begin{itemize}
		\item \url{https://github.com/NicolasSimard/ENT}
	\end{itemize}
	
	Scripts for the calculations available at:
	\begin{itemize}
		\item \url{https://github.com/NicolasSimard/ENT/blob/master/comps/ULcomps1.gp}
		\item \url{https://github.com/NicolasSimard/ENT/blob/master/comps/ULcomps2.gp}
	\end{itemize}
}
\end{document}
