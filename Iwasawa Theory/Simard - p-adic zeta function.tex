...
Using the analogy between $\varphi$ and $V_p$ and $\psi$ and $U_p$ discussed above, we see that the restriction operator lokks like the $p$-stabilisation operator on modular forms.
...
\end{align*}
This is consistent with our observation that the restriction operator can be thought of as a $p$-stabilisation operator, since multiplication by $1-p^k$ corresponds to $p$-stabilisation on $L$-functions (i.e. removing the euler factors at $p$).
