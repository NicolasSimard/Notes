...
\frame{
	...
	converges and is a modular form in $M_k(\text{SL}_2(\Z))$. After renormalisation, the $q$-expansion of this Eisenstein series is
...
\frame{
	...
	\[G_2(2)=\frac{1}{8\pi\Im(z)}-\frac{1}{24}+\sum_{n=1}^\infty\sigma(n)q^n.\]
